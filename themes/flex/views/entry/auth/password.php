...
<div>
   ...
   <ul>
      ...
      <li class="Buttons">
         <?php
            echo $this->Form->Button('Sign In',array('class' => 'button medium green btn-block'));
   ...
   <ul>
      ...
      <li class="Buttons">
         <?php
            echo $this->Form->Button('Request a new password',array('class' => 'button medium green btn-block'));
