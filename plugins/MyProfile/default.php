...
$PluginInfo['MyProfile'] = array(
   'Description' => 'This is a plugin to add a "My Profile" tab to the profile with custom fields.',
   'Version' => '0.1',
   'Author' => "Steve Suppe",
   'AuthorEmail' => '',
   'AuthorUrl' => '',
...
class MyProfile implements Gdn_IPlugin {
	...
	public function ProfileController_AddProfileTabs_handler(&$Sender) {
		$Sender->AddProfileTab("MyProfile_ProfileTab", "/profile/myprofile/view/".$Sender->User->UserID."/".Gdn_Format::Url($Sender->User->Name),'MyProfile_ProfileTab','MyProfile_ProfileTab');
