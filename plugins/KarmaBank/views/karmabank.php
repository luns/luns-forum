...
<div class="Profile">
   <h1><?php echo sprintf(T('%s\'s Karma Balance'),$this->ThisUser->Name); ?></h1>
...
<div class="Amount"><?php echo sprintf("%01.2f",$Transaction->Amount) ?><span class="Karma"></span></div>
<div class="Clear"></div>
</div>
</li>
<?php } ?>
...
<div class="Amount"><?php echo sprintf("%01.2f",$this->Data['Balance']) ?><span class="Karma"><?php echo T('Karma') ?></span></div>
<div class="Clear"></div>
</div>
</li>
</ul>
