...
$PluginInfo['FirstLastNames'] = array(
   'Description' => 'Adds required Имя and Фамилия fields for users and allows them to be displayed in place of usernames',
   'Version' => '1.3.2',
	...
	public function ProfileController_EditMyAccountAfter_Handler($Sender)
	{
		...
		<li>
			...
			if( C('Plugins.FirstLastNames.NickName') )
				...
				echo $Sender->Form->Label('Имя', 'FirstName');
		...
		<li>
			<?php
			echo $Sender->Form->Label('Фамилия', 'LastName');
