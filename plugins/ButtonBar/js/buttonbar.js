   ...
   ButtonBar = {
      ...
      PrepareBBCode: function(ButtonBarObj, TextArea) {
         $("<div></div>")
            ...
            .html('Вы можете использовать <b><a href="http://en.wikipedia.org/wiki/BBCode">BBCode</a></b> для ваших сообщений.')
      ...
      PrepareHtml: function(ButtonBarObj, TextArea) {
         ...
         $("<div></div>")
            .addClass('ButtonBarMarkupHint')
            .html('Вы можете использовать <b><a href="http://htmlguide.drgrog.com/cheatsheet.php">Simple Html</a></b> для ваших сообщений.')
            .insertAfter(TextArea);
      },
      ...
      PrepareMarkdown: function(ButtonBarObj, TextArea) {
         ...
         $("<div></div>")
            .addClass('ButtonBarMarkupHint')
            .html('Вы можете использовать <b><a href="http://en.wikipedia.org/wiki/Markdown">Markdown</a></b> для ваших сообщений.')
            .insertAfter(TextArea);
      },
